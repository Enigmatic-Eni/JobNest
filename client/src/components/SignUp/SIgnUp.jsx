          ...
          {step === 1 && (
            <div className="space-y-6">
              <div className="text-center">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Choose Your Path</h3>
                <p className="text-gray-600 text-sm">Select the type of account you'd like to create</p>
              </div>
              
              <div className="space-y-3">
               {[
  { value: 'jobseeker', label: 'Job Seeker', icon: '👤', desc: 'Looking for opportunities' },
  { value: 'recruiter', label: 'Recruiter', icon: '🏢', desc: 'Hiring talented people' }
].map((option) => (
  <div
    key={option.value}
    onClick={() => {
      setAccountType(option.value);
      setFormData(prev => ({ ...prev, accountType: option.value })); // Update formData with accountType
    }}
      ...
      <div className={`w-5 h-5 rounded-full border-2 ${
        ...
        {accountType === option.value && (
          ...
          {step === 2 && (
            <div className="space-y-5">
              ...
              {[
                ...
                { name: 'password', label: 'Password', type: 'password', placeholder: 'Create a password (min. 6 characters)' }
              ].map((field) => (
                <div key={field.name}>
          ...
          {step === 3 && accountType === 'jobseeker' && (
            <div className="space-y-5">
              <div className="text-center">
                <h3 className="text-lg font-semibold text-gray-800 mb-2">Job Seeker Details</h3>
                <p className="text-gray-600 text-sm">Help us match you with the right opportunities</p>
              </div>
          ...
          {step === 3 && accountType === 'recruiter' && (
            <div className="space-y-5">
              ...
              {[
                ...
                { name: 'companyWebsite', label: 'Company Website', type: 'url', placeholder: 'https://example.com' },
          ...
          <div className="flex justify-between pt-8">
            ...
            {step < 3 && (
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-500 to-indigo-600 text-white rounded-xl font-medium hover:from-blue-600 hover:to-indigo-700 disabled:from-gray-300 disabled:to-gray-400 disabled:cursor-not-allowed transform hover:scale-105 transition-all duration-200 ml-auto"
              >
                Next →
              </button>
            )}
