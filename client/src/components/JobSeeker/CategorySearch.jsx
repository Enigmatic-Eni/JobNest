...
const handleCategoryChange = (category) => {
  ...
  return (
    <div >
      ...
      <button className=' bg-[#EFF5FF] text-text text-xs rounded-sm border border-[#8BC3FF] py-2 px-4'>Full Stack</button>
      <button className=' bg-[#FFF5F3] text-text text-xs rounded-sm border border-[#FFBABA] py-2 px-4'>Nigeria</button>
      </div>
