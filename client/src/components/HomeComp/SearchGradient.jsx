  ...
  return (
    <div>
        <div className="purple-grad bg-gradient-to-r from-theme to-[#130121] py-20 text-white flex flex-col items-center rounded-2xl justify-center">
            ...
            <p className=' text-center text-sm mb-14 mt-4'>Your Next Big career Move Starts Right Here <br></br>Explore The Best Job Opportunities and Take the First Step Toward Your Future!</p>
